...
flake8 $module --exclude '__init__.py' --max-line-length=120 --show-source || { exit 1; }

# Ignore import errors for __init__
flake8 $module --filename=__init__.py  --max-line-length=120 --ignore=F --show-source || { exit 1; }
