...
results_path = "thesis_results_static_exploration"
a_T_1 = np.load("{}/res_static_mpc_exploration_T_1/res_data.npy".format(results_path)).item()
a_T_2 = np.load("{}/res_static_mpc_exploration_T_2/res_data.npy".format(results_path)).item()
a_T_3 = np.load("{}/res_static_mpc_exploration_T_3/res_data.npy".format(results_path)).item()
a_T_4 = np.load("{}/res_static_mpc_exploration_T_4/res_data.npy".format(results_path)).item()
a_T_5 = np.load("{}/res_static_mpc_exploration_T_5/res_data.npy".format(results_path)).item()
...
plt.savefig("{}/inf_gain_static.png".format(results_path))
