...
@pytest.mark.xfail(
    reason="Need to fix the DummySSM to have correct and meaningful (i.e. varying values) derivatives ")
...
def _parse_derivative_checker_output(out):
    ...
    if m:
        ...
        pytest.fail(
            "what is the output if there is no fail?. Or did the interface change?")
