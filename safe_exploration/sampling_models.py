...
class MonteCarloSafetyVerification:
    ...
    def sample_n_step(self,x0,K,k,n=1,n_samples = 1000):
        ...
        assert np.shape(K) == (n,self.n_u,self.n_s), "Required shape of K is ({},{},{})".format(n,self.n_u,self.n_s)    
        assert np.shape(k) == (n,self.n_u) , "Required shape of k is ({},{})".format(n,self.n_u)
